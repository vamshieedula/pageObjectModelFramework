package com.pageObjectEcom.vr.helper.excel;
...
public class ExcelHelper {
	...
	public void updateResult(String excelLocation, String sheetName, String testCaseName, String testStatus) {
		...
		try {
			...
			FileInputStream file = new FileInputStream(new File(excelLocation));
			// creates workbook instance
			XSSFWorkbook workBook = new XSSFWorkbook(file);

			// get sheetname from workbook
			XSSFSheet sheet = workBook.getSheet(sheetName);

			// count number of active rows in each sheet
	...
	public static void main(String[] args) {
		...
		String excelLocation = System.getProperty("user.dir") + "\\src\\main\\resources\\exceldata\\Login.xlsx";

		//Object[][] data = excelHelp.getExcelData(excelLocation, "Login");

		//System.out.println(data);
		excelHelp.updateResult(excelLocation, "TestScripts", "Login", "pass");
		excelHelp.updateResult(excelLocation, "TestScripts", "Registration", "fail");
		excelHelp.updateResult(excelLocation, "TestScripts", "Add to cart", "pass");
